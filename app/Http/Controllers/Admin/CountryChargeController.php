...
class CountryChargeController extends Controller
{
    ...
    {
        $this->middleware('permission:countryCharge-table')->only('index', 'show');
        $this->middleware('permission:countryCharge-add')->only('create', 'store');
        $this->middleware('permission:countryCharge-edit')->only('edit', 'update');
        $this->middleware('permission:countryCharge-delete')->only('destroy');
    }

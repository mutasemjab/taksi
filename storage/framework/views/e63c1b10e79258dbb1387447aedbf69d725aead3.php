        ...
        <div class="card-body">
            ...
            <form action="<?php echo e(route('services.store')); ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="price_of_real_one_minute_morning"><?php echo e(__('messages.price_of_real_one_minute')); ?> (<?php echo e(__('messages.Morning')); ?>) <span class="text-danger">*</span></label>
                            <input type="number" step="0.01" class="form-control" id="price_of_real_one_minute_morning" name="price_of_real_one_minute_morning" value="<?php echo e(old('price_of_real_one_minute_morning', 0)); ?>" required min="0">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="price_of_real_one_minute_evening"><?php echo e(__('messages.price_of_real_one_minute')); ?> (<?php echo e(__('messages.Evening')); ?>) <span class="text-danger">*</span></label>
                            <input type="number" step="0.01" class="form-control" id="price_of_real_one_minute_evening" name="price_of_real_one_minute_evening" value="<?php echo e(old('price_of_real_one_minute_evening', 0)); ?>" required min="0">
                        </div>
                    </div>
                </div>

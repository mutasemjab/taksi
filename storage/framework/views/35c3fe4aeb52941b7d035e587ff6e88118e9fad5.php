<?php $__env->startSection('title', __('messages.Add New Admin')); ?>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h3 class="card-title"><?php echo e(__('messages.Add New Admin')); ?></h3>
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('admin.admin.store')); ?>">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                       ...
                                       placeholder="<?php echo e(__('messages.Enter password')); ?>" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="is_super" id="is_super_yes" value="1"
                                           <?php echo e(old('is_super') == '1' ? 'checked' : ''); ?> required>
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="is_super" id="is_super_no" value="0"
                                           <?php echo e(old('is_super') == '0' ? 'checked' : ''); ?> required>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\taksi\resources\views/admin/admin/create.blade.php ENDPATH**/ ?>
<?php $__env->startSection('title', __('messages.Edit Employee')); ?>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h3 class="card-title"><?php echo e(__('messages.Edit Employee')); ?></h3>
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('admin.employee.update', $admin->id)); ?>">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                       ...
                                       placeholder="<?php echo e(__('messages.Enter employee name')); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                                       ...
                                       placeholder="<?php echo e(__('messages.Enter employee email')); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-4">
                            <div class="col-12">
                                <label class="form-label"><?php echo e(__('messages.Roles')); ?> <span class="text-danger">*</span></label>
                                <div class="card">
                                    <div class="card-body">
                                        <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="form-check mb-3">
                                                <input class="form-check-input" type="radio" name="role_id"
                                                       ...
                                                       <?php echo e(old('role_id', $admin->roles->first()?->id) == $role->id ? 'checked' : ''); ?> required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <a href="<?php echo e(route('admin.employee.index')); ?>" class="btn btn-secondary ms-2">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\taksi\resources\views/admin/employee/edit.blade.php ENDPATH**/ ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            ...
                            <!-- Primary Service -->
                            <div class="mb-3">
                                <label class="font-weight-bold text-primary"><?php echo e(__('messages.Primary_Service')); ?> <span class="text-danger">*</span></label>
                                <small class="d-block text-muted mb-2"><?php echo e(__('messages.Primary_service_cannot_be_disabled_by_driver')); ?></small>
                            ...
                            <!-- Optional Services -->
                            <div class="mb-3">
                                <label class="font-weight-bold text-info"><?php echo e(__('messages.Optional_Services')); ?></label>
                                <small class="d-block text-muted mb-2"><?php echo e(__('messages.Driver_can_toggle_these_services')); ?></small>
                                <div class="checkbox-list">
                                    <?php $__currentLoopData = $allServices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <label class="checkbox">
                                            <input type="checkbox" name="optional_service_ids[]" value="<?php echo e($service->id); ?>" 
                                            <?php if(isset($driver) && $driver->services->where('pivot.service_type', 2)->contains($service->id)): ?>
                                                checked
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" class="form-control" id="balance" name="balance" value="<?php echo e(old('balance', $driver->balance)); ?>" readonly>
                        </div>
